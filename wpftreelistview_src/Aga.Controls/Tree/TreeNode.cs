...
namespace Aga.Controls.Tree
{
	public sealed class TreeNode : INotifyPropertyChanged
	{
		...
		public void ChildrenChanged(object sender, NotifyCollectionChangedEventArgs e)
		{
			switch (e.Action)
			{
				case NotifyCollectionChangedAction.Add:
					if (e.NewItems != null)
					{
						...
						foreach (object obj in e.NewItems)
						{
							...
							ITreeModel tn = obj as ITreeModel;
							if (tn!=null)
								this.Children.First(n => n.Tag == obj).HasChildren = tn.HasChildren(this);
							index++;
						}
					}
					break;
